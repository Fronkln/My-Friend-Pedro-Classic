...
public class RootSharedScript : MonoBehaviour
{
    ...
    public virtual bool allowLeaderboard
    {
        get
        {
            return (UnityEngine.Object)this.steamLeaderboardsScript != (UnityEngine.Object)null && this.steamLeaderboardsScript.AreLeaderboardsAllowed() && !MFPClassic.Hook.devMode;
        }
    }
    ...
    public virtual string GetLeaderboardName(int lvlNr, string idCheck, bool givePlain)
    {
        ...
        MFPClassic.MFPEditorUtils.Log("Returning " + lhs + "from ID: " + lvlNr.ToString());
