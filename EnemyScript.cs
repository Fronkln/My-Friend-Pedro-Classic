...
public class EnemyScript : MonoBehaviour
{
    ...
    private bool enemyDiedFailSafeS;
    private Vector3 fakeVelocityS;
    private bool runLogicS;
    private bool runLogicDoOnceS;
    ...
    private float doorHideTimerS;
    private bool attackAfterDoorSpawnS;
    private float bulletTimeAliveS;
    private bool doorSpawnS;
    private bool idleS;
    private bool doneWithDoorAppearAnimationDoOnceS;
    private float healthS;
    private float framesSincePlayerLastSeenS;
    private float idleWalkTimerS;
    private float standStillTimerS;
    private float targetCrouchAmountS;
    private bool shotInLegS;
    private bool hasBeenOnScreenS;
    private bool initialAimCompleteS;
    private float initialAimFireDelayS;
    private float alertAmountS;
    private float alertAmountTargetS;
    private float remoteTriggeredTimerS;
    private bool hasBeenRemoteTriggeredS;
    private float knockedBackTimerS;
    private bool bleedFromHandS;
    private bool attackModeDoOnceS;
    private bool allowBulletHitS;
    private float fireDelayS;
    private float shootTimerS;
    private float shotsInARowS;
    private bool beenGibbedS;
    private bool doorSpawnDoOnceS;
    private bool reloadingS;
    private float reloadLayerWeightS;
    private float ammoS;
    private bool runToAlarmDoOnceS;
    private bool rappellingS;
    private Transform rappellTransformS;
    private StringScript rappellStringScriptS;
    private float rapellTimerS;
    private bool cantBeHarmedS;
    private bool dontRagDollS;
    private Transform useHatS;
    private float sColHeightS;
    private float timeAliveS;
    ...
    {
        this.enemyDiedFailSafeS = this.enemyDiedFailSafe;
        this.fakeVelocityS = this.fakeVelocity;
        this.runLogicS = this.runLogic;
        this.runLogicDoOnceS = this.runLogicDoOnce;
        ...
        this.doorHideTimerS = this.doorHideTimer;
        this.attackAfterDoorSpawnS = this.attackAfterDoorSpawn;
        this.bulletTimeAliveS = this.bulletTimeAlive;
        this.doorSpawnS = this.doorSpawn;
        this.idleS = this.idle;
        this.doneWithDoorAppearAnimationDoOnceS = this.doneWithDoorAppearAnimationDoOnce;
        this.healthS = this.health;
        this.framesSincePlayerLastSeenS = this.framesSincePlayerLastSeen;
        this.idleWalkTimerS = this.idleWalkTimer;
        this.standStillTimerS = this.standStillTimer;
        this.targetCrouchAmountS = this.targetCrouchAmount;
        this.shotInLegS = this.shotInLeg;
        this.hasBeenOnScreenS = this.hasBeenOnScreen;
        this.initialAimCompleteS = this.initialAimComplete;
        this.initialAimFireDelayS = this.initialAimFireDelay;
        this.alertAmountS = this.alertAmount;
        this.alertAmountTargetS = this.alertAmountTarget;
        this.remoteTriggeredTimerS = this.remoteTriggeredTimer;
        this.hasBeenRemoteTriggeredS = this.hasBeenRemoteTriggered;
        this.knockedBackTimerS = this.knockedBackTimer;
        this.bleedFromHandS = this.bleedFromHand;
        this.attackModeDoOnceS = this.attackModeDoOnce;
        this.allowBulletHitS = this.allowBulletHit;
        this.fireDelayS = this.fireDelay;
        this.shootTimerS = this.shootTimer;
        this.shotsInARowS = this.shotsInARow;
        this.beenGibbedS = this.beenGibbed;
        this.doorSpawnDoOnceS = this.doorSpawnDoOnce;
        this.reloadingS = this.reloading;
        this.reloadLayerWeightS = this.reloadLayerWeight;
        this.ammoS = this.ammo;
        this.runToAlarmDoOnceS = this.runToAlarmDoOnce;
        this.rappellingS = this.rappelling;
        this.rappellTransformS = this.rappellTransform;
        this.rappellStringScriptS = this.rappellStringScript;
        this.rapellTimerS = this.rapellTimer;
        this.cantBeHarmedS = this.cantBeHarmed;
        this.dontRagDollS = this.dontRagDoll;
        this.useHatS = this.useHat;
        this.timeAliveS = this.timeAlive;
        if (!this.simpleEnemy)
            return;
        this.sColHeightS = this.sCol.height;
    }

    public virtual void loadState()
    {
        this.enemyDiedFailSafe = this.enemyDiedFailSafeS;
        this.fakeVelocity = this.fakeVelocityS;
        this.runLogic = this.runLogicS;
        this.runLogicDoOnce = this.runLogicDoOnceS;
        ...
        this.doorHideTimer = this.doorHideTimerS;
        this.attackAfterDoorSpawn = this.attackAfterDoorSpawnS;
        this.bulletTimeAlive = this.bulletTimeAliveS;
        this.doorSpawn = this.doorSpawnS;
        this.idle = this.idleS;
        this.doneWithDoorAppearAnimationDoOnce = this.doneWithDoorAppearAnimationDoOnceS;
        this.health = this.healthS;
        this.framesSincePlayerLastSeen = this.framesSincePlayerLastSeenS;
        this.idleWalkTimer = this.idleWalkTimerS;
        this.standStillTimer = this.standStillTimerS;
        this.targetCrouchAmount = this.targetCrouchAmountS;
        this.shotInLeg = this.shotInLegS;
        this.hasBeenOnScreen = this.hasBeenOnScreenS;
        this.initialAimComplete = this.initialAimCompleteS;
        this.initialAimFireDelay = this.initialAimFireDelayS;
        this.alertAmount = this.alertAmountS;
        this.alertAmountTarget = this.alertAmountTargetS;
        this.remoteTriggeredTimer = this.remoteTriggeredTimerS;
        this.hasBeenRemoteTriggered = this.hasBeenRemoteTriggeredS;
        this.knockedBackTimer = this.knockedBackTimerS;
        this.bleedFromHand = this.bleedFromHandS;
        this.attackModeDoOnce = this.attackModeDoOnceS;
        this.allowBulletHit = this.allowBulletHitS;
        this.fireDelay = this.fireDelayS;
        this.shootTimer = this.shootTimerS;
        this.shotsInARow = this.shotsInARowS;
        this.runToAlarmDoOnce = this.runToAlarmDoOnceS;
        this.rappelling = this.rappellingS;
        this.rappellTransform = this.rappellTransformS;
        this.rappellStringScript = this.rappellStringScriptS;
        this.rapellTimer = this.rapellTimerS;
        this.cantBeHarmed = this.cantBeHarmedS;
        this.dontRagDoll = this.dontRagDollS;
        this.useHat = this.useHatS;
        this.timeAlive = this.timeAliveS;
        if (this.simpleEnemy)
            this.sCol.height = this.sColHeightS;
        else if (this.beenGibbed)
        {
            ((Joint)this.lowerBack.GetComponent(typeof(CharacterJoint))).connectedBody = ((Joint)this.upperLegR.GetComponent(typeof(CharacterJoint))).connectedBody = ((Joint)this.upperLegL.GetComponent(typeof(CharacterJoint))).connectedBody = (Rigidbody)this.center.GetComponent(typeof(Rigidbody));
            ((Joint)this.head.GetComponent(typeof(CharacterJoint))).connectedBody = (Rigidbody)this.upperBack.GetComponent(typeof(Rigidbody));
        }
        this.beenGibbed = this.beenGibbedS;
        this.doorSpawnDoOnce = this.doorSpawnDoOnceS;
        this.reloading = this.reloadingS;
        this.reloadLayerWeight = this.reloadLayerWeightS;
        this.ammo = this.ammoS;
        this.loadGameFireDelay = 120f;
    }
    ...
    public virtual void Awake()
    {
        ...
        MeshRenderer gibHeadMr = gibHead.GetComponent<MeshRenderer>();

        gibHeadMr.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
        gibHeadMr.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;

        MeshRenderer gibHipsMr = gibHips.GetComponent<MeshRenderer>();

        gibHipsMr.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
        gibHipsMr.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;

        MeshRenderer gibLowerBodyMr = gibLowerBody.GetComponent<MeshRenderer>();

        gibLowerBodyMr.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
        gibLowerBodyMr.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;

        MeshRenderer gibLowerArmMr = gibLowerArm.GetComponent<MeshRenderer>();

        gibLowerArmMr.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
        gibLowerArmMr.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;

        MeshRenderer gibLowerLegMr = gibLowerLeg.GetComponent<MeshRenderer>();

        gibLowerLegMr.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
        gibLowerLegMr.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;

        MeshRenderer gibUpperArmMr = gibUpperArm.GetComponent<MeshRenderer>();

        gibUpperArmMr.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
        gibUpperArmMr.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;

        MeshRenderer gibUpperBodyMr = gibUpperBody.GetComponent<MeshRenderer>();

        gibUpperBodyMr.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
        gibUpperBodyMr.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;


        MeshRenderer gibUpperLegMr = gibUpperLeg.GetComponent<MeshRenderer>();

        gibUpperLegMr.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
        gibUpperLegMr.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;
    }
    ...
    public virtual void Start()
    {
        ...
        if ((UnityEngine.Object)this.rBody == (UnityEngine.Object)null)
            this.rBody = (Rigidbody)this.gameObject.GetComponent(typeof(Rigidbody));
        if (this.skyfall || (UnityEngine.Object)this.motorcycle != (UnityEngine.Object)null || !this.mainBodyKinematic)
        {
        ...
        MeshRenderer machineGunRend = machineGun.GetComponent<MeshRenderer>();
        machineGunRend.material = MFPClassic.MFPClassicAssets.m4Gun.GetComponent<MeshRenderer>().material;

        machineGun.GetComponent<MeshFilter>().sharedMesh = MFPClassic.MFPClassicAssets.m4Gun.GetComponent<MeshFilter>().sharedMesh;

        machineGunRend.lightProbeUsage = UnityEngine.Rendering.LightProbeUsage.Off;
        machineGunRend.reflectionProbeUsage = UnityEngine.Rendering.ReflectionProbeUsage.Off;
        ...
        if (!this.doorSpawn && (UnityEngine.Object)this.motorcycle == (UnityEngine.Object)null && !this.simpleEnemy)
        {
            int index = 0;
            Rigidbody[] bodiesInChildren = this.rigidBodiesInChildren;
            for (int length = bodiesInChildren.Length; index < length; ++index)
            {
                if (bodiesInChildren[index].gameObject.layer != 17 && bodiesInChildren[index].gameObject.layer != 14 && ((UnityEngine.Object)bodiesInChildren[index].transform != (UnityEngine.Object)this.useHat && this.disableWeaponPickUpDoThing(bodiesInChildren[index].transform)))
                {
        ...
        head.transform.Find("gamer_hair").gameObject.SetActive(false);
        head.transform.Find("Hats").gameObject.SetActive(false);

        component3.material.mainTexture = MFPClassicAssets.colorablePants.mainTexture;

        UnityEngine.Random.InitState(System.DateTime.Now.Millisecond);

        int enemyType = UnityEngine.Random.Range(1, 4);
        int pantColor = UnityEngine.Random.Range(0, 6);


        bool isBlack = UnityEngine.Random.Range(1, 3) == 1;


        switch (pantColor)
        {
            case 1:
                component3.material.color = new Color32(104, 100, 163, 255);
                break;
            case 2:
                component3.material.color = new Color32(153, 147, 255, 255);
                break;
            case 3:
                component3.material.color = new Color32(66, 56, 96, 255);
                break;
            case 4:
                component3.material.color = new Color32(85, 84, 96, 255);
                break;
            case 5:
                component3.material.color = new Color32(146, 146, 146, 255);
                break;
        ...
        switch (enemyType)
        {
            case 1:
                ...
                if (isBlack)
                    component2.material = MFPClassicAssets.blackEnemyWhiteTop;


                bool hasCapEnemy1 = UnityEngine.Random.Range(0, 2) == 1;

                if (hasCapEnemy1)
                {
                    GameObject cap = Instantiate(MFPClassicAssets.head02Cap, head);
                    useHat = cap.transform;
                    cap.transform.localPosition = new Vector3(0.6139997f, 0.003000022f, -0.0660001f);
                }

                goto case 255;

            case 2:
                Color32 enemyColor = Color.blue;

                int enemy2Col = UnityEngine.Random.Range(1, 4);


                switch (enemy2Col)
                {
                    case 1:
                        enemyColor = new Color32(114, 42, 42, 255);
                        break;
                    case 2:
                        enemyColor = new Color32(45, 64, 120, 255);
                        break;
                    case 3:
                ...
                component2.sharedMesh = MFPClassicAssets.torsorBlacklongSleeve;
                component2.material.mainTexture = null;

                component2.material.color = enemyColor;

                bool hasBandana = UnityEngine.Random.Range(0, 2) == 1;
                bool hasBeanie = UnityEngine.Random.Range(0, 2) == 1;


                if (enemy2Col != 3 && hasBeanie || hasBandana)
                {
                    if (hasBandana)
                    {
                        GameObject bandana = Instantiate(MFPClassicAssets.head02Bandana, head);
                        bandana.transform.localPosition = new Vector3(0.627f, 0.003f, -0.239f);
                        bandana.GetComponentInChildren<MeshRenderer>().material.mainTexture = null;
                        bandana.GetComponentInChildren<MeshRenderer>().material.color = enemyColor;
                    }

                    if (hasBeanie)
                    {
                        GameObject beanie = Instantiate(MFPClassicAssets.head02Beanie, head);
                        beanie.transform.localPosition = new Vector3(0.625f, 0.003f, -0.246f);

                        beanie.GetComponentInChildren<MeshRenderer>().material.mainTexture = null;
                        beanie.GetComponentInChildren<MeshRenderer>().material.color = enemyColor;
                    }
                }
            ...
            case 3:
                ...
                bool hasBeanieEnemy3 = UnityEngine.Random.Range(0, 2) == 1;
                ...
                if (hasBeanieEnemy3)
                {
                    ...
                    beanie.GetComponentInChildren<MeshRenderer>().material.mainTexture = null;
                    beanie.GetComponentInChildren<MeshRenderer>().material.color = Color.black;
                }

                if (!isBlack)
                    component2.material = MFPClassicAssets.whiteEnemyBlackShirt;
                else
                    component2.material = MFPClassicAssets.blackEnemyBlackShirt;

                goto case 255;

            case 255:

                component1.sharedMesh = MFPClassicAssets.head02NoBandanaNoBeanie;

                if (isBlack)
                    component1.material = MFPClassicAssets.head02Black;

                break;
        }

        this.idleWalkTimer = (float)UnityEngine.Random.Range(40, 150);
        ...
        if (this.doorSpawn)
        {
            ...
            if (this.attackAfterDoorSpawn)
            {
                ...
                this.doorHideTimer = (float)UnityEngine.Random.Range(50, 70);
        ...
        {
            if ((UnityEngine.Object)allEnemies1[index3] != (UnityEngine.Object)null && (UnityEngine.Object)allEnemies1[index3] != (UnityEngine.Object)this.gameObject && (allEnemies1[index3].layer == 13 && (double)Vector2.Distance((Vector2)allEnemies1[index3].transform.position, (Vector2)this.transform.position) < 40.0) && !Physics.Linecast(this.transform.position + new Vector3(0.0f, 1.5f, 0.0f), allEnemies1[index3].transform.position + new Vector3(0.0f, 1f, 0.0f), (int)this.layerMaskOnlyLevelCollision))
            {
        ...
        {
            if ((UnityEngine.Object)this.motorcycle == (UnityEngine.Object)null && (UnityEngine.Object)this.stickToTransform == (UnityEngine.Object)null && (SavedData.GetInt("weaponActive1") == 1 && !this.root.isMiniLevel))
            {
                UnityEngine.Random.InitState((int)this.transform.position.magnitude);
                this.weapon = (float)this.root.allowedWeaponsForEnemies[UnityEngine.Random.Range(0, Extensions.get_length((System.Array)this.root.allowedWeaponsForEnemies))];
                if ((double)this.weapon == 6.0)
                {
                    ...
                    {
                        if ((UnityEngine.Object)allEnemies2[index1] != (UnityEngine.Object)this.gameObject)
                        {
                            EnemyScript component6 = (EnemyScript)allEnemies2[index1].GetComponent(typeof(EnemyScript));
                            if ((UnityEngine.Object)component6 != (UnityEngine.Object)null && (double)component6.weapon == 6.0 && (double)Vector3.Distance(this.transform.position, allEnemies2[index1].transform.position) < 25.0)
                            {
                                this.weapon = 1f;
                                break;
                            }
                ...
                if (this.enemiesInRangeAtStart.Length <= 0 && (double)this.weapon >= 3.0)
                    this.weapon = (double)UnityEngine.Random.value <= 0.899999976158142 ? 1f : 3f;
            }
            else
                this.weapon = 1f;
        }
        ...
        this.timeRequiredBeforeCrouch = (float)UnityEngine.Random.Range(120, 240);
        ...
        else if (this.enemyType == 3)
        {
            ...
            this.engageAnimName = (double)UnityEngine.Random.value <= 0.5 ? "Bat_Detect_2" : "Bat_Detect";
        ...
        if ((double)this.voicePitchOffset == 0.0)
            this.voicePitchOffset = UnityEngine.Random.Range(-0.9f, 1.1f);
        ...
        if ((UnityEngine.Object)this.leftHandItem != (UnityEngine.Object)null)
        {
            ...
            if (this.dropItemOnAlert)
            {
                ...
                if ((UnityEngine.Object)this.leftHandItem.GetComponent(typeof(Rigidbody)) == (UnityEngine.Object)null)
                    ((Rigidbody)this.leftHandItem.AddComponent(typeof(Rigidbody))).isKinematic = true;
                if ((UnityEngine.Object)this.leftHandItem.GetComponent(typeof(Collider)) == (UnityEngine.Object)null)
                {
        ...
        if (this.skyfall)
        {
            ...
            this.fireDelay = (float)(180 + UnityEngine.Random.Range(0, 40));
        }
        if ((UnityEngine.Object)this.motorcycle != (UnityEngine.Object)null || (UnityEngine.Object)this.stickToTransform != (UnityEngine.Object)null)
        {
            this.dontCheckDistanceBeforeRunningLogic = true;
            this.standStill = this.standStillInHuntMode = true;
            this.idle = false;
            this.neverReturnToIdle = true;
            if ((UnityEngine.Object)this.motorcycle != (UnityEngine.Object)null)
            {
        ...
        {
            if ((UnityEngine.Object)transformArray1[index5] != (UnityEngine.Object)this.handR && (UnityEngine.Object)transformArray1[index5].parent == (UnityEngine.Object)this.handR)
        ...
        {
            if ((UnityEngine.Object)transformArray2[index6] != (UnityEngine.Object)this.handL && (UnityEngine.Object)transformArray2[index6].parent == (UnityEngine.Object)this.handL)
        ...
        for (int length = characterJointArray.Length; index7 < length; ++index7)
            UnityEngine.Object.DestroyImmediate((UnityEngine.Object)characterJointArray[index7]);
        ...
        for (int length = colliderArray.Length; index8 < length; ++index8)
            UnityEngine.Object.DestroyImmediate((UnityEngine.Object)colliderArray[index8]);
        ...
        for (int length = rigidbodyArray.Length; index9 < length; ++index9)
            UnityEngine.Object.DestroyImmediate((UnityEngine.Object)rigidbodyArray[index9]);
        ...
        for (int length = physicsSoundsScriptArray.Length; index10 < length; ++index10)
            UnityEngine.Object.DestroyImmediate((UnityEngine.Object)physicsSoundsScriptArray[index10]);
    ...
    public virtual void Update()
    {
        ...
        if (!this.dontCheckDistanceBeforeRunningLogic)
        {
            ...
            else if ((double)this.playerDistance < 50.0 && this.enemiesInRangeAtStart.Length > 0)
            {
                ...
                {
                    if ((UnityEngine.Object)enemiesInRangeAtStart[index] != (UnityEngine.Object)null && enemiesInRangeAtStart[index].runLogic)
                        this.runLogic = true;
                }
            }
        }
        ...
        else
        {
            ...
            if (this.hasBeenOnScreen && (this.doorSpawn || this.idle))
            {
                ...
                if (this.playerScript.weapon != 10 && (double)this.remoteTriggeredTimer <= 0.0 && ((double)playerDistance1 < (double)this.playerShootingDetectionRadius && this.playerScript.fireWeapon || this.remoteAlerted))
                {
                    if (this.enemyType != 3)
                    {
                        this.remoteTriggeredTimer = (float)UnityEngine.Random.Range(160, 200);
                        this.alertAmountTarget = UnityEngine.Random.Range(0.75f, 1f);
                        if (!this.alertDoOnce)
                        {
                        ...
                        this.idleWalkTimer = (float)UnityEngine.Random.Range(100, 140);
                        this.targetXSpeed = 0.0f;
                        if (!this.doorSpawn && !this.rappelling && (double)this.weapon != 9.0)
                        {
                            this.dropLeftHandItemCheck();
                            this.animator.CrossFadeInFixedTime("HeardNoise", 0.25f, 0, UnityEngine.Random.Range(0.0f, 0.3f));
                            if ((UnityEngine.Object)this.enemySpeechHandlerScript == (UnityEngine.Object)null || (UnityEngine.Object)this.enemySpeechHandlerScript != (UnityEngine.Object)null && !this.enemySpeechHandlerScript.dontInterrupt)
                            {
                                if ((UnityEngine.Object)this.enemySpeechHandlerScript != (UnityEngine.Object)null && this.enemySpeechHandlerScript.speaking)
                                    this.speak(this.root.GetTranslation("eHeardNoise1"), 0.9f, true);
                                else if ((double)this.root.timeSinceEnemySpokeOnHearing > 300.0 && (double)playerDistance1 < (double)this.playerShootingDetectionRadius / 1.5 && (double)UnityEngine.Random.value > 0.349999994039536)
                                {
            ...
            {
                this.animator.PlayInFixedTime("Electricuted", 0, UnityEngine.Random.value);
                ...
                float num1 = this.transform.position.x + UnityEngine.Random.Range(-0.03f, 0.03f);
                Vector3 position = this.transform.position;
                double num2 = (double)(position.x = num1);
                Vector3 vector3_1 = this.transform.position = position;
                this.ySpeed += UnityEngine.Random.Range(0.01f, 0.04f);
                float num3 = UnityEngine.Random.value;
                Vector3 vector3_2 = new Vector3();
                this.smokeParticle.Emit(this.root.generateEmitParams((double)num3 >= 0.150000005960464 ? ((double)num3 >= 0.300000011920929 ? ((double)num3 >= 0.449999988079071 ? ((double)num3 >= 0.600000023841858 ? ((double)num3 >= 0.75 ? ((double)num3 >= 0.300000011920929 ? this.transform.position : this.head.position) : this.lowerBack.position) : this.upperArmR.position) : this.upperArmL.position) : this.lowerArmR.position) : this.lowerArmL.position, new Vector3((float)UnityEngine.Random.Range(-1, 1), (float)UnityEngine.Random.Range(-1, 1), UnityEngine.Random.Range(-0.2f, 0.2f)), 3f, 2f, new Color(1f, 1f, 1f, 0.035f)), 1);
            ...
            else if (this.doorSpawn)
            {
                ...
                if ((double)this.transform.position.z <= 0.0)
                {
                    ...
                    this.startPos = this.transform.position;
                    this.initialAimFireDelay = (float)UnityEngine.Random.Range(20, 40);
                ...
                if (this.hasBeenOnScreen)
                {
                    ...
                    if (!this.standStill)
                    {
                        ...
                        if ((double)this.idleWalkTimer <= 0.0)
                        {
                            ...
                            this.idleWalkTimer = (float)UnityEngine.Random.Range(120, 240);
                        }
                    ...
                    if (!this.idle)
                    {
                        this.fireDelay = (double)this.weapon != 9.0 ? 0.0f : (float)UnityEngine.Random.Range(80, 100);
            ...
            else if ((UnityEngine.Object)this.runToAlarm != (UnityEngine.Object)null && !this.runToAlarm.hasBeenActivatedAtleastOnce && !this.runToAlarm.activated && ((UnityEngine.Object)this.runToAlarm.currentlyEngagedEnemy == (UnityEngine.Object)this.transform || (UnityEngine.Object)this.runToAlarm.currentlyEngagedEnemy == (UnityEngine.Object)null))
            {
            ...
            else
            {
                if (!this.attackModeDoOnce)
                {
                    ...
                    if ((double)this.root.timeSinceEnemySpokeOnDetection > 240.0 && (double)UnityEngine.Random.value > 0.300000011920929 || (UnityEngine.Object)this.enemySpeechHandlerScript != (UnityEngine.Object)null && this.enemySpeechHandlerScript.speaking)
                    {
                        if (this.theme == 1)
                        {
                ...
                if ((double)this.framesSincePlayerLastSeen < 80.0)
                {
                    if ((double)this.weapon == 9.0)
                    {
                        float num1 = Mathf.Clamp(this.fireDelay * 10f - 300f, 0.0f, this.fireDelay) * ((float)Math.PI / 180f);
                    ...
                    if (this.initialAimComplete && (double)this.loadGameFireDelay <= 0.0 && (double)this.initialAimFireDelay <= 0.0 && (((double)this.playerScript.dodgingCoolDown <= (double)this.root.difficulty * 1.5 - 30.0 + (double)UnityEngine.Random.Range(0, 10) || this.playerScript.dodging) && (double)playerDistance2 < 50.0) && ((double)this.shotsInARow < (double)this.weaponShotsInRow * (double)this.root.difficulty && (double)this.fireDelay <= 0.0 || (double)this.shootTimer >= (double)this.timeInbetweenShots))
                    {
                        this.shootTimer = 0.0f;
                        this.shotsInARow = (double)this.shotsInARow < (double)this.weaponShotsInRow * (double)this.root.difficulty ? this.shotsInARow + 1f : UnityEngine.Random.Range(1f, 3f * this.root.difficulty);
                        this.kFire = true;
                    }
                    if (this.kFire && (double)this.fireDelay <= 0.0)
                    {
                        if (!this.root.pleaseESRB && ((double)this.playerScript.rotationSpeed == 0.0 && ((double)this.playerScript.dodgingCoolDown <= 0.0 || this.root.difficultyMode == 2 && !this.root.isTutorialLevel) && ((double)this.shotsInARow + (this.root.difficultyMode != 1 ? 0.0 : 1.0) >= (double)this.weaponShotsInRow || this.root.difficultyMode == 2 && !this.root.isTutorialLevel) || ((double)this.weapon == 9.0 || (double)this.weapon == 10.0)))
                        {
                            ...
                            this.aimAngleOffset = UnityEngine.Random.Range(num1 - 2f, 2f + num1);
                        }
                        else
                            this.aimAngleOffset = (float)((double)UnityEngine.Random.Range(20, 25) * (double)Mathf.Clamp(1f - Mathf.Clamp01(this.playerDistance / 25f), 0.25f, 1f) * ((double)this.mainPlayerRigidBody.velocity.y >= 0.0 ? ((double)this.mainPlayerRigidBody.velocity.y != 0.0 ? -1.0 : ((double)UnityEngine.Random.value <= 0.5 ? -1.0 : 1.0)) : 1.0));
                    }
                }
                else
                {
            ...
            if (!this.doorSpawn)
            {
                ...
                if (this.enemiesInRangeAtStart.Length > 0)
                {
                    ...
                    for (int length = enemiesInRangeAtStart.Length; index < length; ++index)
                    {
                        if ((UnityEngine.Object)enemiesInRangeAtStart[index] != (UnityEngine.Object)null && (double)Vector2.Distance((Vector2)enemiesInRangeAtStart[index].transform.position, (Vector2)this.transform.position) < 2.0 && ((UnityEngine.Object)enemiesInRangeAtStart[index] != (UnityEngine.Object)null && enemiesInRangeAtStart[index].enabled) && (double)enemiesInRangeAtStart[index].health > 0.0)
            ...
            if (this.bulletHit && !this.cantBeHarmed)
            {
                ...
                if ((UnityEngine.Object)this.useHat != (UnityEngine.Object)null && this.bulletHitName == "Head")
                {
                    ...
                    component2.AddForce(new Vector3(Mathf.Clamp(this.bulletHitVel.x * UnityEngine.Random.Range(0.5f, 0.8f), -3f, 3f), 0.0f, 0.0f) + Vector3.up * (float)UnityEngine.Random.Range(3, 5), ForceMode.VelocityChange);
                ...
                if ((double)this.health <= 0.0)
                {
                    ...
                    else
                    {
                        ...
                        if (!this.simpleEnemy && this.headAudio.isActiveAndEnabled)
                        {
                            ...
                            this.headAudio.clip = this.deathScreams[UnityEngine.Random.Range(0, Extensions.get_length((System.Array)this.deathScreams))];
                            this.headAudio.volume = UnityEngine.Random.Range(0.8f, 1f);
                            this.headAudio.pitch = UnityEngine.Random.Range(0.95f, 1.05f) + 0.5f;
                        ...
                        UnityEngine.Random.InitState((int)this.startPos.magnitude);
                        if (!this.disableWeaponPickup && this.root.killsSinceMedkitDrop > 7 && ((double)UnityEngine.Random.value > 0.300000011920929 && (double)this.playerScript.health <= 0.660000026226044))
                        {
                            /* MEDKIT SPAWN
                            GameObject gameObject = UnityEngine.Object.Instantiate<GameObject>(this.medkit, this.transform.position, Quaternion.Euler((float)UnityEngine.Random.Range(-60, -120), 270f, -90f));
                            ...
                            component.angularVelocity = new Vector3((float)UnityEngine.Random.Range(-1, 1), (float)UnityEngine.Random.Range(-1, 1), (float)UnityEngine.Random.Range(-1, 1));
                            if ((UnityEngine.Object)this.motorcycle != (UnityEngine.Object)null)
                                ((WeaponPickupScript)gameObject.GetComponent(typeof(WeaponPickupScript))).motorcycle = true;
								*/
                            this.root.killsSinceMedkitDrop = 0;
                        }
                        if ((UnityEngine.Object)this.runToAlarm != (UnityEngine.Object)null && (UnityEngine.Object)this.runToAlarm.currentlyEngagedEnemy == (UnityEngine.Object)this.transform)
                        ...
                        {
                            if ((UnityEngine.Object)collidersInChildren[index1] != (UnityEngine.Object)null && collidersInChildren[index1].gameObject.layer != 17 && (!((UnityEngine.Object)collidersInChildren[index1].transform == (UnityEngine.Object)this.useHat) && this.disableWeaponPickUpDoThing(collidersInChildren[index1].transform)))
                            {
                        ...
                        if (!this.dontRagDoll)
                        {
                            ...
                            {
                                if ((UnityEngine.Object)bodiesInChildren[index2] != (UnityEngine.Object)null && (!this.mainBodyKinematic || (UnityEngine.Object)bodiesInChildren[index2].transform != (UnityEngine.Object)this.transform) && (bodiesInChildren[index2].gameObject.layer != 17 && bodiesInChildren[index2].gameObject.layer != 14 && ((UnityEngine.Object)bodiesInChildren[index2].transform != (UnityEngine.Object)this.useHat && this.disableWeaponPickUpDoThing(bodiesInChildren[index2].transform))))
                                {
                                    ...
                                    if ((UnityEngine.Object)rigidBodySlowMotion == (UnityEngine.Object)null)
                                    {
                                    ...
                                    if (bodiesInChildren[index2].gameObject.name == "pistol" || bodiesInChildren[index2].gameObject.name == "uzi" || (bodiesInChildren[index2].gameObject.name == "machinegun" || bodiesInChildren[index2].gameObject.name == "shotgun"))
                                        ...
                                        bodiesInChildren[index2].velocity = !(bodiesInChildren[index2].gameObject.name == "LowerArm_R") || (double)UnityEngine.Random.value <= 0.699999988079071 ? (!(bodiesInChildren[index2].gameObject.name == "LowerArm_L") || (double)UnityEngine.Random.value <= 0.699999988079071 ? (!(bodiesInChildren[index2].gameObject.name == this.bulletHitName) ? new Vector3(this.bulletHitVel.x, (double)this.bulletHitVel.y >= 0.0 ? this.bulletHitVel.y : 0.0f, this.bulletHitVel.z + UnityEngine.Random.Range(-1.5f, 1.5f)) * 0.75f : new Vector3(this.bulletHitVel.x, (float)(((double)this.bulletHitVel.y >= 1.0 ? (double)this.bulletHitVel.y : 1.0) * 2.0), this.bulletHitVel.z) * 1.6f) : new Vector3(this.bulletHitVel.x * 2f, this.bulletHitVel.y, this.bulletHitVel.z)) : new Vector3(this.bulletHitVel.x * -1f, this.bulletHitVel.y, this.bulletHitVel.z);
                                    if (this.skyfall)
                                    {
                        ...
                        if (!this.disableWeaponPickup)
                        {
                            ...
                            if ((UnityEngine.Object)this.motorcycle != (UnityEngine.Object)null)
                            {
                                ...
                                if ((UnityEngine.Object)weaponPickupScript2 != (UnityEngine.Object)null)
                        ...
                        if (this.root.doGore && this.allowGib && (double)this.bulletTimeAlive <= 9.0)
                        {
                            ...
                            if (this.bulletHitName == "Explosion" || this.bulletHitName == "Center" || (this.bulletHitName == "LowerBack" || this.bulletHitName == "UpperBack"))
                            {
                                ...
                                ((Rigidbody)gameObject1.GetComponent(typeof(Rigidbody))).velocity = (new Vector3(UnityEngine.Random.Range(-2f, 1f), UnityEngine.Random.Range(-4f, 2f), 0.0f) + this.bulletHitVel) * 0.5f;
                                ((Rigidbody)gameObject2.GetComponent(typeof(Rigidbody))).velocity = (new Vector3(UnityEngine.Random.Range(-2f, 1f), UnityEngine.Random.Range(-4f, 2f), 0.0f) + this.bulletHitVel) * 0.5f;
                                ((Rigidbody)gameObject4.GetComponent(typeof(Rigidbody))).velocity = (new Vector3(UnityEngine.Random.Range(-2f, 1f), UnityEngine.Random.Range(-4f, 2f), 0.0f) + this.bulletHitVel) * 0.5f;
                                ((Rigidbody)gameObject3.GetComponent(typeof(Rigidbody))).velocity = (new Vector3(UnityEngine.Random.Range(-2f, 1f), UnityEngine.Random.Range(-4f, 2f), 0.0f) + this.bulletHitVel) * 0.5f;
                                ((Rigidbody)gameObject5.GetComponent(typeof(Rigidbody))).velocity = new Vector3(UnityEngine.Random.Range(-0.5f, 0.5f), (float)UnityEngine.Random.Range(6, 8), 0.0f) + this.bulletHitVel * 0.2f;
                                ((Rigidbody)gameObject6.GetComponent(typeof(Rigidbody))).velocity = new Vector3(UnityEngine.Random.Range(-0.5f, 0.5f), UnityEngine.Random.Range(8f, 9f), 0.0f) + this.bulletHitVel * 0.15f;
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.upperArmR.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f) * 0.4f, (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.lowerArmR.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f) * 0.4f, (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.upperArmL.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f) * 0.4f, (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.lowerArmL.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f) * 0.4f, (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.lowerBack.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f) * 0.4f, (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.upperBack.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f) * 0.4f, (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.head.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f) * 0.4f, (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                            ...
                            if (this.bulletHitName == "Explosion" || !this.simpleEnemy && this.bulletHitName == "UpperLeg_L" || (this.bulletHitName == "LowerLeg_L" || this.bulletHitName == "UpperLeg_R" || this.bulletHitName == "LowerLeg_R"))
                            {
                                ...
                                ((Rigidbody)gameObject7.GetComponent(typeof(Rigidbody))).velocity = (new Vector3(UnityEngine.Random.Range(-2f, 1f), UnityEngine.Random.Range(-4f, 2f), 0.0f) + this.bulletHitVel) * 0.5f;
                                ((Rigidbody)gameObject8.GetComponent(typeof(Rigidbody))).velocity = (new Vector3(UnityEngine.Random.Range(-2f, 1f), UnityEngine.Random.Range(-4f, 2f), 0.0f) + this.bulletHitVel) * 0.5f;
                                ((Rigidbody)gameObject9.GetComponent(typeof(Rigidbody))).velocity = (new Vector3(UnityEngine.Random.Range(-2f, 1f), UnityEngine.Random.Range(-4f, 2f), 0.0f) + this.bulletHitVel) * 0.5f;
                                ((Rigidbody)gameObject10.GetComponent(typeof(Rigidbody))).velocity = (new Vector3(UnityEngine.Random.Range(-2f, 1f), UnityEngine.Random.Range(-4f, 2f), 0.0f) + this.bulletHitVel) * 0.5f;
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.upperLegR.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f), (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.lowerLegR.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f), (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.upperLegL.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f), (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.lowerLegL.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / UnityEngine.Random.Range(1.3f, 1.1f), (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                            ...
                            else if (this.bulletHitName == "Head")
                            {
                                ...
                                ((Rigidbody)gameObject6.GetComponent(typeof(Rigidbody))).velocity = (new Vector3(UnityEngine.Random.Range(-1f, 1f), UnityEngine.Random.Range(-4f, 2f), 0.0f) + this.bulletHitVel) * 0.5f;
                                this.bloodMistParticle.Emit(this.root.generateEmitParams(this.head.position + new Vector3(0.0f, 0.0f, -1f), this.bulletHitVel / 2f, (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), new Color(1f, 1f, 1f, 1f)), 1);
                        ...
                        else if (!this.simpleEnemy && (double)UnityEngine.Random.value > 0.600000023841858)
                        ...
                        if (!this.simpleEnemy && !this.deathAudioSource.isPlaying)
                        {
                            ...
                            this.deathAudioSource.volume = UnityEngine.Random.Range(0.8f, 1f);
                            this.deathAudioSource.pitch = UnityEngine.Random.Range(0.95f, 1.05f);
            ...
            if (this.root.doGore && this.bleedFromHand && !this.root.cinematicShot)
            {
                ...
                {
                    this.bloodDropsParticle.Emit(this.root.generateEmitParams(this.handL.position, Vector3.zero, UnityEngine.Random.Range(0.1f, 0.2f), 1f, new Color(1f, 1f, 1f, 1f)), 1);
                    this.bleedFromHandTimer = (float)UnityEngine.Random.Range(30, 90);
                }
            }
            ...
            {
                if (this.enemyType == 3 && !this.fightMode && (!this.idle && this.onGround) && (double)UnityEngine.Random.value > 0.400000005960464)
                {
                    this.kFire = true;
                    this.fightPoseBlend = 1f;
            ...
            {
                this.ySpeed = (float)UnityEngine.Random.Range(10, 12);
            ...
            if ((double)this.health > 0.0)
            {
                ...
                if (this.skyfall)
                {
                    float num1 = (float)-((double)this.transform.position.y - (double)this.skyfallYPos + (double)Mathf.Sin(Time.time * this.skyfallYMoveSpeed) * (double)this.skyfallYMoveAmount + (double)Mathf.Sin(Time.time * 2f) * 2.0 + (double)UnityEngine.Random.Range(-1.6f, 1.6f));
                    Vector3 velocity = this.rBody.velocity;
            ...
            if (this.kFire)
            {
                if (this.fightMode)
                {
                    if ((double)this.punchTimer <= 0.0)
                    {
                        if (this.enemyType == 3)
                        {
                            this.animator.CrossFade((double)UnityEngine.Random.value <= 0.5 ? "Bat_Attack" : "Bat_Attack_2", 0.05f, 1, 0.0f);
                            this.punchTimer = 50f + UnityEngine.Random.value * 10f;
                        }
                        else
                        {
                            this.animator.CrossFade(RuntimeServices.op_Addition("Punch", (object)Mathf.Round(UnityEngine.Random.Range(0.5f, 2.5f))), 0.1f, 1, 0.0f);
                            ...
                            this.generalAudioSource.volume = UnityEngine.Random.Range(0.8f, 1f);
                            this.generalAudioSource.pitch = UnityEngine.Random.Range(0.85f, 1.15f);
            ...
            if ((UnityEngine.Object)this.stickToTransform != (UnityEngine.Object)null)
            {
            ...
            if (!this.root.dead || !((UnityEngine.Object)this.enemySpeechHandlerScript != (UnityEngine.Object)null) || !this.enemySpeechHandlerScript.speaking)
                return;
            this.speak(string.Empty, 1f, false);
        }
    }
    ...
    public virtual void LateUpdate()
    {
        if (this.runLogic)
        {
                ...
                if ((double)this.ammo > 0.0)
                {
                    if (!this.reloading)
                    {
                        ...
                        else if ((double)this.weapon == 2.0)
                        {
                            ...
                            gameObject1.transform.rotation *= Quaternion.Euler(UnityEngine.Random.Range(-2f, 2f), 0.0f, 0.0f);
                        ...
                        else if ((double)this.weapon == 3.0)
                        {
                            ...
                            bulletScript.friendly = false;
                            bulletScript.doPostSetup();
                            bullet.transform.rotation *= Quaternion.Euler(UnityEngine.Random.Range(-2f, 2f), 0.0f, 0.0f);
                            this.fireDelay = 8f;
                        }
                        else if ((double)this.weapon == 4.0)
                        {
                            ...
                            bulletScript.friendly = false;
                            bulletScript.doPostSetup();
                            gameObject1.transform.rotation *= Quaternion.Euler(UnityEngine.Random.Range(-3f, 3f), 0.0f, 0.0f);
                            this.fireLeftGun = !this.fireLeftGun;
                            this.fireDelay = 4f;
                        }
                        else if ((double)this.weapon == 5.0)
                        ...
                        else if ((double)this.weapon == 6.0)
                        {
                            ...
                            for (int index = 0; index < 8; ++index)
                            {
                                ...
                                bulletScript.friendly = false;
                                bullet.transform.rotation *= Quaternion.Euler(UnityEngine.Random.Range(-9f, 9f), 0.0f, 0.0f);
                        ...
                        else if ((double)this.weapon == 10.0)
                        {
                            ...
                            gameObject2.transform.rotation *= Quaternion.Euler(UnityEngine.Random.Range(-1f, 1f), 0.0f, 0.0f);
                            this.fireDelay = 120f;
                        }
                        if ((UnityEngine.Object)bulletScript != (UnityEngine.Object)null)
                        {
                            bulletScript.friendly = false;
                            bulletScript.fromTransform = this.transform;
                        }
            ...
            if (this.rappelling)
            {
                ...
                if (this.playerScript.swinging && (UnityEngine.Object)this.playerScript.swingTransform == (UnityEngine.Object)this.rappellTransform.parent && (double)this.playerScript.grabLength > (double)this.playerScript.ropeLength - 4.5)
            ...
            {
                float num4 = 0.05f;
                this.lowerBack.localScale = Vector3.one + new Vector3((float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4);
                this.lowerArmR.localScale = Vector3.one + new Vector3((float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4) * 0.5f;
                this.lowerArmL.localScale = Vector3.one + new Vector3((float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4) * 0.5f;
                this.upperLegR.localScale = Vector3.one + new Vector3((float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4);
                this.upperLegL.localScale = Vector3.one + new Vector3((float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4);
                this.lowerLegR.localScale = Vector3.one + new Vector3((float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4);
                this.lowerLegL.localScale = Vector3.one + new Vector3((float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4, (float)UnityEngine.Random.Range(-1, 1) * num4);
    ...
    {
        if (!((UnityEngine.Object)this.leftHandItem != (UnityEngine.Object)null) || !this.dropItemOnAlert || !((UnityEngine.Object)this.leftHandItem.transform.parent != (UnityEngine.Object)null))
            return;
    ...
    public virtual void remoteTriggerEnemies()
    {
        if (this.enemiesInRangeAtStart.Length <= 0)
            return;
        if ((UnityEngine.Object)this.enemySpeechHandlerScript != (UnityEngine.Object)null && !this.enemySpeechHandlerScript.dontInterrupt && (!this.hasBeenRemoteTriggered && (double)this.root.timeSinceEnemySpokeOnDetection > 120.0) && (double)UnityEngine.Random.value > 0.100000001490116)
        {
            float num = UnityEngine.Random.value;
            if ((double)num > 0.75)
            {
                if (this.theme == 1)
                    this.speak(this.root.GetTranslation("eRemoteAlert1"), 2f, true);
                else if (this.theme == 2)
                    this.speak(this.root.GetTranslation("eRemoteAlert5"), 2f, true);
                else if (this.theme == 3)
                    this.speak(this.root.GetTranslation("eRemoteAlert9"), 2f, true);
                else if (this.theme == 4)
                    this.speak(this.root.GetTranslation("eRemoteAlert13"), 2f, true);
                else if (this.theme == 5)
                    this.speak(this.root.GetTranslation("eRemoteAlert17"), 2f, true);
            }
            else if ((double)num > 0.5)
            {
                if (this.theme == 1)
                    this.speak(this.root.GetTranslation("eRemoteAlert2"), 2f, true);
                else if (this.theme == 2)
                    this.speak(this.root.GetTranslation("eRemoteAlert6"), 2f, true);
                else if (this.theme == 3)
                    this.speak(this.root.GetTranslation("eRemoteAlert10"), 2f, true);
                else if (this.theme == 4)
                    this.speak(this.root.GetTranslation("eRemoteAlert14"), 2f, true);
                else if (this.theme == 5)
                    this.speak(this.root.GetTranslation("eRemoteAlert18"), 2f, true);
            }
            else if ((double)num > 0.25)
            {
                if (this.theme == 1)
                    this.speak(this.root.GetTranslation("eRemoteAlert3"), 2f, true);
                else if (this.theme == 2)
                    this.speak(this.root.GetTranslation("eRemoteAlert7"), 2f, true);
                else if (this.theme == 3)
                    this.speak(this.root.GetTranslation("eRemoteAlert11"), 2f, true);
                else if (this.theme == 4)
                    this.speak(this.root.GetTranslation("eRemoteAlert15"), 2f, true);
                else if (this.theme == 5)
                    this.speak(this.root.GetTranslation("eRemoteAlert19"), 2f, true);
            }
            else if (this.theme == 1)
                this.speak(this.root.GetTranslation("eRemoteAlert4"), 2f, true);
            else if (this.theme == 2)
                this.speak(this.root.GetTranslation("eRemoteAlert8"), 2f, true);
            else if (this.theme == 3)
                this.speak(this.root.GetTranslation("eRemoteAlert12"), 2f, true);
            else if (this.theme == 4)
                this.speak(this.root.GetTranslation("eRemoteAlert16"), 2f, true);
            else if (this.theme == 5)
                this.speak(this.root.GetTranslation("eRemoteAlert20"), 2f, true);
            this.root.timeSinceEnemySpokeOnDetection = 0.0f;
        }
        int index = 0;
        EnemyScript[] enemiesInRangeAtStart = this.enemiesInRangeAtStart;
        for (int length = enemiesInRangeAtStart.Length; index < length; ++index)
        {
            if ((UnityEngine.Object)enemiesInRangeAtStart[index] != (UnityEngine.Object)null)
            {
    ...
    public virtual void changeWeapon(float w)
    {
        ...
        this.sniper.gameObject.SetActive(false);
        this.crossbow.gameObject.SetActive(false);
        if ((UnityEngine.Object)this.club != (UnityEngine.Object)null)
            this.club.gameObject.SetActive(false);
        SkinnedMeshRenderer component1 = (SkinnedMeshRenderer)this.handR.Find("hand_01").GetComponent(typeof(SkinnedMeshRenderer));
        SkinnedMeshRenderer component2 = (SkinnedMeshRenderer)this.handL.Find("hand_01_L").GetComponent(typeof(SkinnedMeshRenderer));
        if ((double)w == 0.0)
        {
            this.club.gameObject.SetActive(true);
        ...
        {
            this.sniper.gameObject.SetActive(true);
            component1.SetBlendShapeWeight(0, 100f);
            component2.SetBlendShapeWeight(0, 50f);
            this.aimWithLeftArm = false;
        }
        ...
        if ((double)this.weapon != 0.0 && (UnityEngine.Object)this.weaponSound[(int)w] != (UnityEngine.Object)null)
        {
            this.handRAudio.clip = this.weaponSound[(int)w];
            this.handLAudio.clip = this.weaponSound[(int)w];
        }
        this.weapon = w;
        this.ammo = this.root.ammoFullClip[(int)this.weapon];
    }

    public virtual void playGunSound(bool isRight)
    {
        if (!this.handRAudio.gameObject.activeInHierarchy)
            return;
        if (isRight)
        {
    ...
    public virtual void punch(int fist)
    {
        if (this.reloading)
            return;
        RaycastHit hitInfo = new RaycastHit();
        Vector3 vector3 = new Vector3(this.neck.position.x, this.neck.position.y, this.transform.position.z) + Vector3.right * (!this.faceRight ? -3f : 3f);
        if (!Physics.Raycast(this.transform.position, (this.mainPlayer.position - this.transform.position).normalized, out hitInfo, 2.5f, (int)this.layerMaskOnlyPlayer))
            return;
        this.playerScript.bulletHit = true;
        this.playerScript.bulletStrength += 0.4f;
        this.playerScript.bulletFromTransform = this.transform;
        this.playerScript.bulletHitVel = new Vector3(!this.faceRight ? -10f : 10f, 1f, 0.0f);
        this.generalAudioSource.clip = this.punchHitSound;
        this.generalAudioSource.volume = UnityEngine.Random.Range(0.8f, 1f);
        this.generalAudioSource.pitch = UnityEngine.Random.Range(0.85f, 1.15f);
        this.generalAudioSource.Play();
        this.cameraScript.screenShake += 0.5f;
        this.cameraScript.bigScreenShake += 0.3f;
        if (this.root.showNoBlood)
            return;
        this.bloodMistParticle.Emit(this.root.generateEmitParams(hitInfo.point, Vector3.zero, (float)UnityEngine.Random.Range(3, 5), UnityEngine.Random.Range(0.3f, 1f), !this.root.doGore ? new Color(0.0f, 0.0f, 0.0f, 0.5f) : new Color(1f, 1f, 1f, 0.5f)), 1);
        for (int index = 0; index < 10; ++index)
            this.bloodDropsParticle.Emit(this.root.generateEmitParams(hitInfo.point, new Vector3((float)(-(double)this.transform.forward.x * 3.5) + (float)UnityEngine.Random.Range(-4, 4), (float)(-(double)this.transform.forward.y * 3.5) + (float)UnityEngine.Random.Range(1, 6), UnityEngine.Random.Range(-0.5f, 0.5f)), UnityEngine.Random.Range(0.05f, 0.2f), UnityEngine.Random.Range(0.8f, 1.3f), !this.root.doGore ? new Color(0.0f, 0.0f, 0.0f, 1f) : new Color(1f, 1f, 1f, 1f)), 1);
    }
    ...
    public virtual void knockBack(bool toRight, float knockTimer)
    {
        if (this.cantBeHarmed)
            return;
        if ((double)this.weapon != 9.0 && (UnityEngine.Object)this.animator != (UnityEngine.Object)null)
        {
            this.animator.CrossFadeInFixedTime("KnockedBack", 0.1f, 1, 0.0f);
            this.knockedBackTimer = !this.alwaysGetBulletHitHeadshot ? knockTimer : knockTimer / 3f;
        }
        if (this.doorSpawn)
            return;
        this.xSpeed = (float)((!toRight ? -12 : 12) / (this.enemyType == 1 || this.enemyType == 3 ? 3 : 1));
        this.targetXSpeed = (float)((!toRight ? -2 : 2) / (this.enemyType == 1 || this.enemyType == 3 ? 2 : 1));
        if (this.enemyType != 3)
            return;
        this.engageAnimFinished = true;
    }
    ...
    {
        this.headFakeRot = Quaternion.LookRotation(new Vector3(this.mousePos.x, this.mousePos.y, this.head.position.z) - this.head.position, !this.faceRight ? Vector3.forward : Vector3.back);
    }

    public virtual void reload()
    {
        if (this.reloading || (double)this.ammo >= (double)this.playerScript.ammoFullClip[(int)this.weapon] || (double)this.weapon == 0.0)
            return;
        this.reloading = true;
        if ((double)this.weapon == 1.0)
            this.animator.Play("SinglePistolReload", 5, 0.0f);
        else if ((double)this.weapon == 2.0 || (double)this.weapon == 4.0)
            this.animator.Play("DoublePistolReload", 5, 0.0f);
        else if ((double)this.weapon == 6.0)
            this.animator.Play("ShotgunReload", 5, 0.0f);
        else
            this.animator.Play("SinglePistolReload", 5, 0.0f);
    }
    ...
    public virtual void finishedReloading()
    {
        ...
        this.ammo = this.playerScript.ammoFullClip[(int)this.weapon];
    }
    ...
    public virtual void shotgunReload()
    {
        if (!this.reloading)
            return;
        ++this.ammo;
        if ((double)this.ammo >= (double)this.playerScript.ammoFullClip[(int)this.weapon])
            return;
        this.animator.CrossFade("ShotgunReload", 0.05f, 5, 0.5f);
    }
    ...
    {
        if ((double)this.weapon == 1.0 || (double)this.weapon == 3.0)
        {
    ...
    {
        if (!((UnityEngine.Object)this.motorcycle == (UnityEngine.Object)null) || this.root.trailerMode)
            return;
        this.enemySpeechHandlerScript = (EnemySpeechHandlerScript)this.GetComponent(typeof(EnemySpeechHandlerScript));
        if ((UnityEngine.Object)this.enemySpeechHandlerScript == (UnityEngine.Object)null)
            this.enemySpeechHandlerScript = (EnemySpeechHandlerScript)this.gameObject.AddComponent(typeof(EnemySpeechHandlerScript));
        this.enemySpeechHandlerScript.speak(txt, speed, additive);
    }
    ...
    public virtual void speakNoAnimation(string txt, float speed, bool additive)
    {
        ...
        if ((UnityEngine.Object)this.enemySpeechHandlerScript == (UnityEngine.Object)null)
            this.enemySpeechHandlerScript = (EnemySpeechHandlerScript)this.gameObject.AddComponent(typeof(EnemySpeechHandlerScript));
        this.enemySpeechHandlerScript.dontAnimate = true;
        this.enemySpeechHandlerScript.speak(txt, speed, additive);
    }

    public virtual float calculateActualBulletHitStrength()
    {
        return this.enemyType != 3 && this.enemyType != 2 && (this.bulletKillOnHeadshot && !this.alwaysGetBulletHitHeadshot) && (this.bulletHitName == "Head" && (double)this.bulletTimeAlive != 999.0) ? (0.5f + this.bulletStrength) * this.damageMultiplier : (!this.bulletHitName.Contains("Leg") ? this.bulletStrength : this.bulletStrength / 1.5f) * this.damageMultiplier;
    }

    private bool disableWeaponPickUpDoThing(Transform trnsfrm)
    {
        int num1 = !this.disableWeaponPickup ? 1 : 0;
        if (num1 != 0)
            return num1 != 0;
        int num2 = this.disableWeaponPickup ? 1 : 0;
        if (num2 != 0)
            num2 = (UnityEngine.Object)trnsfrm != (UnityEngine.Object)this.pistolR ? 1 : 0;
        if (num2 != 0)
            num2 = (UnityEngine.Object)trnsfrm != (UnityEngine.Object)this.pistolL ? 1 : 0;
        if (num2 != 0)
            num2 = (UnityEngine.Object)trnsfrm != (UnityEngine.Object)this.uziR ? 1 : 0;
        if (num2 != 0)
            num2 = (UnityEngine.Object)trnsfrm != (UnityEngine.Object)this.uziL ? 1 : 0;
        if (num2 != 0)
            num2 = (UnityEngine.Object)trnsfrm != (UnityEngine.Object)this.shotgun ? 1 : 0;
        if (num2 != 0)
            num2 = (UnityEngine.Object)trnsfrm != (UnityEngine.Object)this.machineGun ? 1 : 0;
        return num2 == 0 ? num2 != 0 : (UnityEngine.Object)trnsfrm != (UnityEngine.Object)this.sniper;
    }
