...
public class LevelCompleteScreenScript : MonoBehaviour
{
    ...
    public virtual void Start()
    {
        ...
        this.rootShared.DoEndOfLevelShowTopLeaderboardScore(this.rootShared.GetLeaderboardName(MFPClassic.MapManager.currentLevel - 1, !this.root.GetCCheck() ? string.Empty : "-999", false));
    }
